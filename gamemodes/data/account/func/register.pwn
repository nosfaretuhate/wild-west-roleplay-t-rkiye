...
CMD:charactercreate(playerid) {
	...
	await_arr(dialog_response) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_LIST,"Character Creation - Gender","Male\nFemale","Select","Exit");
	...
	await_arr(dialog_response_0) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_LIST,"Character Creation - Race","Caucasian\nHispanic\nAfrican\nAsian\nNative","Select","Exit");
	...
	await_arr(dialog_response_1) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_LIST,"Character Creation - Starting Town","Longcreek\nFremont","Select","Exit");
	...
	for(;;) {
		switch(error) {
			case 0: await_arr(dialog_response_2) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_INPUT,"Character Creation - Age","Input your character's age below (8-80).","Select","Exit");
			case 1: await_arr(dialog_response_2) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_INPUT,"Character Creation - Age","You need to put an age in for your character.\n\nInput your character's age below (8-80).","Select","Exit");
			case 2: await_arr(dialog_response_2) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_INPUT,"Character Creation - Age","Your character's age needs to be a numeric value.\n\nInput your character's age below (8-80).","Select","Exit");
			case 3: await_arr(dialog_response_2) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_INPUT,"Character Creation - Age","Your character can not be younger than 8 or older than 80.\n\nInput your character's age below (8-80).","Select","Exit");
		}
	...
	await_arr(dialog_response_3) ShowPlayerAsyncDialog(playerid,DIALOG_STYLE_MSGBOX,"Character Creation - Overview",string,"Continue","Cancel");
